        ...
        <Grid container spacing={8}>
                      ...
                      <Card className={classes.cart} >
                        ...
                        <div className={classes.details}>
                          <CardContent className={classes.content}>
                            ...
                            <Typography type="subheading" component="h3" className={classes.itemShop} color="primary">Rs. {item.product.price}</Typography>
                            <span className={classes.itemTotal}>Rs.{item.product.price}</span>
            ...
            <Grid item xs={5} sm={5}>
              <Card className={classes.innerCard}>
                ...
                <Typography type="subheading" component="h3" className={classes.thanks} color="primary">Thank you for booking with us! <br/>You can track the status of your booking on this page.</Typography>
              </Card>
            </Grid>
        </Grid>
      </Card>
